...
// matching product find karne ke liye
...
// ye product aaray provide karta hai
export function LoadProductsFetch() {
  const promise = fetch("https://supersimplebackend.dev/products")
    ...
    .catch((error) => {
      console.log("unexpected error occour please ttry again later ");
    });
  return promise;
}
...
export const products = [
  ...
  },
  {
    ...
    image: "images/products/RC-car.webp",
    name: "Formula 1 RC car",
    rating: {
      stars: 3.5,
      count: 5907,
    },
  ...
  {
    id: "15b6fc6f-327a-4ec4-896f-486349e85a100d",
  ...
  {
    id: "15b6fc6f-327a-4ec4-896f-486349e85a5d",
  ...
  {
    id: "15b6fc6f-327a-4ec4-896f-486349e85a4dcscscfscs",
    image: "images/products/McLeran.jpg",
    name: "McLaren P1",
    rating: {
      stars: 3.5,
      count: 5907,
  ...
  {
    id: "15b6fc6f-327a-4ec4-896f-486349e85a7d",
    image: "images/products/HitGel.webp",
    name: "Hit Gel",
    rating: {
      stars: 3.5,
      count: 57,
  ...
  },
  {
    ...
    priceCents: 19900,
    keywords: ["mouse", "gaming mouse", "gaming", "output device"],
  },
  {
    id: "ID2",
    image: "images/products/tuff-gamining-laptop.jpg",
    name: "tuff a-16 gaming laptop for students",
    rating: {
      stars: 4,
      count: 298,
    },
    priceCents: 219999,
    keywords: ["laptop", "gaming laptop", "gaming", "tuff gaming laptop"],
  },
].map((productDetails) => {
  if (productDetails.type === "clothing") {
    return new Clothing(productDetails);
